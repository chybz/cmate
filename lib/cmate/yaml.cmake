...
function(cmate_yaml_dump_map JSON VAR INDENT)
    set(OPTS "")
    set(SINGLE JSON TO_VAR INDENT)
    set(MULTI "")
...
function(cmate_yaml_get_type JSON VAR)
    ...
    set(${VAR} ${T} PARENT_SCOPE)
endfunction()

function(cmate_yaml_dump JSON VAR)
    cmate_yaml_get_type("${JSON}" T)
    set(CONTENT "---")
    ...
    elseif(T STREQUAL "ARRAY")
        cmate_yaml_dump_seq(JSON ${JSON} TO_VAR_CONTENT INDENT ${INDENT})
    elseif(T STREQUAL "OBJECT")
        cmate_yaml_dump_map(JSON ${JSON} TO_VAR_CONTENT INDENT ${INDENT})
    endif()
endfunction()
